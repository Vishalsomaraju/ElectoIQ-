        ...
        >
          ...
          <div className="flex gap-3">
            <button
              ...
              className="px-6 py-3 rounded-xl bg-india-saffron text-white font-semibold hover:bg-[#e8891f] transition-colors"
            >
              Try Again
            </button>
            <a
              href="/"
              className="px-6 py-3 rounded-xl border border-slate-300 dark:border-white/20 text-slate-700 dark:text-white/80 font-semibold"
            >
              Go Home
            </a>
          </div>
