...
const steps = [
  {
    id: 1, emoji: '📋', title: 'Check Eligibility',
  ...
  {
    id: 2, emoji: '🔍', title: 'Find Your Name on Voter Roll',
  ...
  {
    id: 3, emoji: '📝', title: 'Register as a Voter (Form 6)',
  ...
  {
    id: 4, emoji: '🪪', title: 'Receive Your Voter ID (EPIC)',
  ...
  {
    id: 5, emoji: '📍', title: 'Find Your Polling Booth',
  ...
  {
    id: 6, emoji: '🗓️', title: 'Check the Polling Date',
  ...
  {
    id: 7, emoji: '🗳️', title: 'Vote on Polling Day',
  ...
  {
    id: 8, emoji: '✅', title: 'Verify Your Vote (VVPAT)',
